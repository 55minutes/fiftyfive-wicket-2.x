...
The necessary JAR has been included in this lib directory, and its path is referenced in the POM so
that this project can build successfully. Its inclusion is licensed under Apache Software License,
Version 2.0. Copyright 2010 Stefan Fußenegger.
